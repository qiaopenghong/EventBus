...
import static com.example.lrycache.Images.imageThumbUrls;
...
public class PhotoWallAdapter extends RecyclerView.Adapter<PhotoWallAdapter.MyViewHolder> {
    ...
    public PhotoWallAdapter(Context context, int textViewResourceId, String[] imageThumbUrls,RecyclerView photoWall) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                context).inflate(R.layout.photo_layou,parent,
                false));
        return holder;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.iv.setTag(imageThumbUrls[position]);
        holder.iv.setImageResource(R.mipmap.ic_launcher);
        loadBitmaps(holder.iv,imageThumbUrls[position]);
    }
